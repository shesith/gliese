<?php 
// --
class C_Supportmonthly extends Controller {
    ...
    public function index() {
        ...
        $this->functions->check_permissions($this->segment->get('modules'), 'Supportmonthly');
        // --
        $this->view->set_js('index');       // -- Load JS
        $this->view->set_menu(array('modules' => $this->segment->get('modules'), 'view' => 'Supportmonthly')); // -- Active Menu
    ...
    public function get_supportmonthly() { 
      ...
      if ($request === 'GET') {
          ...
          // --
          $obj = $this->load_model('Supportmonthly');
          // --
          $response = $obj->get_supportmonthly();
          // --
    ...
    // --
    public function delete_supportmonthly() {
      // --
      $this->functions->validate_session($this->segment->get('isActive'));
      // --
      $request = $_SERVER['REQUEST_METHOD'];
      ...
      if ($request === 'POST') {
          ...
          // --
          if (!empty($input['id_supportmonthly'])) {
              // --
              $id_supportmonthly = $this->functions->clean_string($input['id_supportmonthly']);
              // --
              $bind = array(
                  'id_supportmonthly' => $id_supportmonthly
              );
              // --
              $obj = $this->load_model('Supportmonthly');
              $response = $obj->delete_supportmonthly($bind);
              // --
              switch ($response['status']) {
                  // --
                  case 'OK':
