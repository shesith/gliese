                ...
                <div class="content-header row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-start mb-0">Venta por Nota de Venta</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" id="create_income_details_form" class="row" onsubmit="return false">
                            <!-- First Row -->
                            <div class="row mb-3">
                                <div class="col-md-4"> <!-- Amplía el ancho de la columna del Cliente -->
                                    <label class="form-label">Cliente(*)</label>
                                    <select name="business_name_cli" class="form-select select2" required>
                                        <!-- Opciones para el select -->
                                    </select>
                                </div>
                                <div class="col-md-4"> <!-- Iguala el ancho de la columna de Moneda -->
                                    <label class="form-label">Moneda</label>
                                    <input name="coins" type="text" class="form-control" disabled>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Fecha (*)</label>
                                    <input name="fecha_actual" type="text" class="form-control" id="fecha_actual" readonly>
                                </div>
                            </div>
                            <!-- Second Row -->
                            <div class="row mb-3">
                                <div class="col-md-2">
                                    ...
                                    <input name="document_number_cli" type="text" placeholder="Nº de Documento o RUC" class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Dirección</label>
                                    <input name="address_cli" type="text" placeholder="Ingrese su Dirección" class="form-control">
                                </div>
                                <div class="col-md-3">
                                    <div>
                            ...
                            <div class="col-12">
                                ...
                                <button type="button" class="btn btn-secondary" onclick="window.location.href='Salenote/index.php'">Cancelar</button>
                            </div>
                        </form>
                    </div>
                </div>
