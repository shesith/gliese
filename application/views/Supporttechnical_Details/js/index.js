...
// --
function get_reason_transfer() { /** Función Modificada */
    $.ajax({
        url: BASE_URL + 'Supporttechnical/get_reason_transfer', // Actualiza la URL de la solicitud
        type: 'GET',
        dataType: 'json',
        contentType: false,
        processData: false,
        ...
        success: function(data) {
            if (data.status === 'OK') {
                ...
                $('#create_income_details_form :input[name=rt_description]').html(html);
            }
        }
    });
}
