...
function destroy_datatable() {
    // --
    $('#datatable-referralguide').dataTable().fnDestroy();
}

// --
function refresh_datatable() {
    // --
    $('#datatable-referralguide').DataTable().ajax.reload();
}
...
function load_datatable() {
    ...
    destroy_datatable();
    // --
    let dataTable = $('#datatable-referralguide').DataTable({
        // --
        ajax: {
...
$(document).on('click', '.create-new', function() {
    // --
    window.location.assign(BASE_URL + 'Referralguide_Details');
})
