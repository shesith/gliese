    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.status === 'OK') {
                ...
                $('#create_proforma_details_form :input[name=business_name]').html(html);
            }
        }
    })
}
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.status === 'OK' && data.data.length > 0) {
                $('#create_proforma_details_form :input[name=coins]').val(data.data[0].name);
            }
        }
    });
}
...
function get_igv() {
    $.ajax({
        ...
        success: function(data) {
            if (data.status === 'OK' && data.data.length > 0) {
                $('#create_proforma_details_form :input[name=igv]').val(data.data[0].value);
            }
        }
    });
}
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.status === 'OK') {
                ...
                // -- Set values for select
                $('#create_proforma_details_form :input[name=vt_description]').html(html);
            }
        }
    });
}
