            ...
            <div class="content-body">
                ...
                <section id="subcategories">
                    ...
                    <div class="content-header row">
                        <div class="content-header-left col-md-9 col-12 mb-2">
                            <div class="row breadcrumbs-top">
                                <div class="col-12">
                                    <h2 class="content-header-title float-start mb-0">Lista de subcategorías</h2>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="table" id="datatable-subcategory">
                                    <thead>
                                        <tr>
                                            <th>Sección</th>
                                            <th>Categoría</th>
                    ...
                    <div class="modal fade" id="create_subcategory_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"> <!--  aria-hidden="true" -->
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body px-sm-5 pb-5">
                                    <div class="text-center mb-2">
                                        <h1 class="mb-1">Agregar nueva Subcategoría</h1>
                                    </div>
                                    <form method="POST" enctype="multipart/form-data" id="create_subcategory_form" class="row" onsubmit="return false">
                                        <div class="col-12">
                                        ...
                                        <div class="mb-1 col-12">
                                            <div>
                                                ...
                                                <select name="id_category" class="form-select select2" id="select-category-create" data-msg="" required>
                                                </select>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="col-12 text-center">
                                            <button id="btn_create_subcategory" type="submit" class="btn btn-primary mt-2 me-1">Guardar</button>
                    ...
                    <!-- Update Subcategories Modal -->
                    <div class="modal fade" id="update_subcategory_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"> <!--  aria-hidden="true" -->
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header bg-transparent">
                                    <button type="reset" class="btn-close reset" data-bs-dismiss="modal" aria-label="Close"></button>
                                ...
                                <div class="modal-body px-sm-5 pb-5">
                                    <div class="text-center mb-2">
                                        <h1 class="mb-1">Actualizar Subcategoría</h1>
                                    </div>
