...
function destroy_datatable() {
    // --
    $('#datatable-salesgeneralreport').dataTable().fnDestroy();
}

// --
function refresh_datatable() {
    // --
    $('#datatable-salesgeneralreport').DataTable().ajax.reload();
}
...
function load_datatable() {
    ...
    destroy_datatable();
    // --
    let dataTable = $('#datatable-salesgeneralreport').DataTable({
        // --
        ajax: {
