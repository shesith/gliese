...
function destroy_datatable() {
    // --
    $('#datatable-loanproducts').dataTable().fnDestroy();
}

// --
function refresh_datatable() {
    // --
    $('#datatable-loanproducts').DataTable().ajax.reload();
}
...
function load_datatable() {
    ...
    destroy_datatable();
    // --
    let dataTable = $('#datatable-loanproducts').DataTable({
        // --
        ajax: {
            url: BASE_URL + 'Loanproducts/get_loanproducts',
            cache: false,
        },
        columns: [
            { data: 'date' },
...
$(document).on('click', '.create-new', function() {
    // --
    window.location.assign(BASE_URL + 'Loanproducts_Details'); 
})
