...
// Función para establecer la fecha actual en el campo de entrada "fecha_actual"
function getFechaActual() {
    ...
    var fechaActualElement = document.getElementById("fecha_actual");
    if (fechaActualElement) {
        fechaActualElement.value = fechaActual.toLocaleDateString("es-ES", options);
    }
}
