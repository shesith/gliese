...
function destroy_datatable() {
    // --
    $('#datatable-payorder').dataTable().fnDestroy();
}

// --
function refresh_datatable() {
    // --
    $('#datatable-payorder').DataTable().ajax.reload();
}
...
function load_datatable() {
    ...
    destroy_datatable();
    // --
    let dataTable = $('#datatable-payorder').DataTable({
        // --
        ajax: {
            url: BASE_URL + 'Payorder/get_payorder',
            cache: false,
        },
        columns: [
            { data: 'date' },
...
$(document).on('click', '.create-new', function() {
    // --
    window.location.assign(BASE_URL + 'Payorder_Details'); 
})
