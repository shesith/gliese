  ...
  <div class="content-wrapper container-xxl p-0">
    ...
    <div class="content-body">
      ...
      <section id="company">
        ...
        <div class="modal fade" id="create_config_modal" tabindex="-1" aria-labelledby="createConfigModalLabel"
          aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="createConfigModalLabel">
                  <img src="<?= BASE_URL ?>/public/app-assets/images/logo/sunat.svg" alt="Icono"
              ...
              <div class="modal-body">
                <form id="sunat_config_form">
                  ...
                  <div class="mb-2">
                    ...
                    <input type="password" class="form-control" id="contrasena_certificado"
                      name="contrasena_certificado" required>
                  </div>
                  <div class="mb-2">
        ...
        <!-- Modal para cargar configuración de Sistema-->
        <div class="modal fade" id="create_config_modal2" tabindex="-1" aria-labelledby="createConfigModalLabel2"
          aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="createConfigModalLabel2">
                  <img src="<?= BASE_URL ?>/public/app-assets/images/svg/config.svg" alt="Icono"
                    style="width: 30px; height: 30px; margin-right: 10px;">
                  Configuración de Sistema
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
