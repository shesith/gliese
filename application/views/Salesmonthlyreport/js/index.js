...
function destroy_datatable() {
    // --
    $('#datatable-salesmonthlyreport').dataTable().fnDestroy();
}

// --
function refresh_datatable() {
    // --
    $('#datatable-salesmonthlyreport').DataTable().ajax.reload();
}
...
function load_datatable() {
    ...
    destroy_datatable();
    // --
    let dataTable = $('#datatable-salesmonthlyreport').DataTable({
        // --
        ajax: {
