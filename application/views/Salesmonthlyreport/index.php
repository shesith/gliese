                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" id="create_salesgeneralreport_details_form" class="row" onsubmit="return false">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-2">
                                <br>
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#create_Salesmonthlyreport_modal">Mostrar</button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <table class="table" id="datatable-salesmonthlyreport">
                                            <thead>
                                                <tr>
                                                    <th>Fecha</th>
                                                    <th>Cliente</th>
