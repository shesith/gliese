...
function destroy_datatable() {
    // --
    $('#datatable-purchasesreport').dataTable().fnDestroy();
}

// --
function refresh_datatable() {
    // --
    $('#datatable-purchasesreport').DataTable().ajax.reload();
}
...
function load_datatable() {
    ...
    destroy_datatable();
    // --
    let dataTable = $('#datatable-purchasesreport').DataTable({
        // --
        ajax: {
            url: BASE_URL + 'Purchasesreport/get_purchasesreport',
            cache: false,
        },
        columns: [
            { data: 'code' },
