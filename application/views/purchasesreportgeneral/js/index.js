...
function destroy_datatable() {
    // --
    $('#datatable-purchasesreportgeneral').dataTable().fnDestroy();
}

// --
function refresh_datatable() {
    // --
    $('#datatable-purchasesreportgeneral').DataTable().ajax.reload();
}
...
function load_datatable() {
    ...
    destroy_datatable();
    // --
    let dataTable = $('#datatable-purchases_reportgeneral').DataTable({
        // --
        ajax: {
